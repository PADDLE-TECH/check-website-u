            ...
            <div class="col-md-7 col-A1 col-sm-12 ">
                ...
                <table>
                    <tr>
                        ...
                        <td>Wondering when all transactions will just be seamless?</td>
                    </tr>
                    <tr>
                        <td><img src="../assets/images2/Vector.png" ></td>
                        <td>Tired of POS or change wahala?</td>
                    </tr>
                    <tr>
                        <td><img src="../assets/images2/Vector.png" ></td>
                        <td>Feeling unsafe with card transactions?</td>
                    </tr>
                    <tr>
                        <td><img src="../assets/images2/Vector.png" ></td>
                        <td>Tired of carrying cash and not sure on how it was spent?</td>
                    </tr>
                    <tr>
                        <td><img src="../assets/images2/Vector.png" ></td>
                        <td>Probably wondering how to avoid the next queue?</td>
                    </tr>
                </table>
        ...
        <div class="row second-row">
            <div class="col-md-6">
                <div class="img-container">
                    <img src="../assets/images2/Check-Website__PHONE-1.png">
                </div>
            </div>
...
.forth-row li:nth-child(1){
    background-color: #FFE2B6;
}
.forth-row li:nth-child(3){
    background: #EBE7FF;
}
.forth-row li:nth-child(5){
    background: #C1EDD4;
}
.forth-row li:nth-child(7){
    background: #FFD3D3;
}
.forth-row li:nth-child(9){
    background: #D1EBFF;
}
.forth-row button {
    float: left;
